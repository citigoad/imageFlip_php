(function ($) {
    ...
    $.imgAreaSelect = function (img, options) {
        var $img = $(img),
            ...
            position = 'absolute',
            startX, startY, scaleX, scaleY, resizeMargin = 10,
            resize, minWidth, minHeight, maxWidth, maxHeight, aspectRatio, shown, x1, y1, x2, y2, selection = {
                x1: 0,
                y1: 0,
                x2: 0,
                y2: 0,
        ...
        if ($.browser.msie && $.browser.version >= 9) img.src = img.src
    };
